import { deleteTaskQuery, taskQuery, tasksWithProjectsQuery, updateTaskQuery } from '@/utils/supaQueriests'
import { useMemoize } from '@vueuse/core'
import type { Task, TasksWithProjects } from '@/utils/supaQueriests'
