...
import { taskQuery } from '@/utils/supaQueriests';
import type { Task } from '@/utils/supaQueriests';
...
<template>
  <Table v-if="task">
    ...
    <TableRow>
      ...
      <TableCell>
        <div class="flex">
          <Avatar class="-mr-4 border border-primary hover:scale-110 transition-transform" v-for="collab in task?.collaborators" :key="collab">
