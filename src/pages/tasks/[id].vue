...
<template>
  <div class="flex flex-col justify-center items-center gap-5">
    ...
    <Button @click="triggerDelete" class="self-end w-full max-w-40" variant=destructive>
      <Transition name="scale" mode="out-in">
        <iconify-icon v-if="loading" icon="tabler:loader-3" class="animate-spin text-lg"></iconify-icon>
        <iconify-icon v-else icon="lucide:trash-2" class="text-lg"></iconify-icon>
      </Transition>
      Delete Task
    </Button>
